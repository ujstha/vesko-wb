...
const FeaturesSection = () => {
  ...
  const features = [
    {
      titleKey: "forOnlineVendor.features.items.mobileApp.title",
      descriptionKey: "forOnlineVendor.features.items.mobileApp.description",
      highlightsKey: "forOnlineVendor.features.items.mobileApp.highlights",
    ...
    {
      titleKey: "forOnlineVendor.features.items.logisticsReady.title",
      descriptionKey: "forOnlineVendor.features.items.logisticsReady.description",
      highlightsKey: "forOnlineVendor.features.items.logisticsReady.highlights",
    ...
    {
      titleKey: "forOnlineVendor.features.items.paymentsBuiltIn.title",
      descriptionKey: "forOnlineVendor.features.items.paymentsBuiltIn.description",
      highlightsKey: "forOnlineVendor.features.items.paymentsBuiltIn.highlights",
    ...
    {
      titleKey: "forOnlineVendor.features.items.socialisedSelling.title",
      descriptionKey: "forOnlineVendor.features.items.socialisedSelling.description",
      highlightsKey: "forOnlineVendor.features.items.socialisedSelling.highlights",
    ...
    {
      titleKey: "forOnlineVendor.features.items.allInOneDashboard.title",
      descriptionKey: "forOnlineVendor.features.items.allInOneDashboard.description",
      highlightsKey: "forOnlineVendor.features.items.allInOneDashboard.highlights",
      ...
      <Container className='relative'>
        ...
        >
          ...
          >
            ...
            >
              {t("forOnlineVendor.features.title")}
            </Text>
            <Text className='text-xl text-gray-600 md:text-2xl'>
              {t("forOnlineVendor.features.subtitle")}
            </Text>
          </motion.div>
          ...
          >
            <div className='mx-auto max-w-3xl rounded-2xl bg-gradient-to-r from-blue-50 to-purple-50 p-12'>
              <Text className='mb-4 text-2xl font-bold text-gray-900'>
                {t("forOnlineVendor.features.cta.title")}
              </Text>
              <Text className='mb-8 text-lg text-gray-600'>
                {t("forOnlineVendor.features.cta.description")}
              </Text>
              <div className='flex flex-wrap items-center justify-center gap-4 text-sm text-gray-500'>
                <div className='flex items-center gap-2'>
                  <i className={`${RemixIcons.check} text-green-500`} />
                  <span>{t("forOnlineVendor.features.cta.trustIndicators.freeTrial")}</span>
                </div>
                <div className='flex items-center gap-2'>
                  <i className={`${RemixIcons.check} text-green-500`} />
                  <span>{t("forOnlineVendor.features.cta.trustIndicators.noSetupFees")}</span>
                </div>
                <div className='flex items-center gap-2'>
                  <i className={`${RemixIcons.check} text-green-500`} />
                  <span>{t("forOnlineVendor.features.cta.trustIndicators.support")}</span>
                </div>
              </div>
            </div>
          </motion.div>
