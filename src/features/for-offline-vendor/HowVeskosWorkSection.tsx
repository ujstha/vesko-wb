...
const HowVeskosWorkSection = () => {
  ...
  const steps = [
    {
      titleKey: "forOfflineVendor.howItWorks.steps.signup.title",
      descriptionKey: "forOfflineVendor.howItWorks.steps.signup.description",
      icon: RemixIcons.signup,
      color: "from-blue-500 to-blue-600",
      step: "01",
    },
    {
      titleKey: "forOfflineVendor.howItWorks.steps.listProducts.title",
      descriptionKey: "forOfflineVendor.howItWorks.steps.listProducts.description",
      icon: RemixIcons.list,
      color: "from-green-500 to-green-600",
      step: "02",
    },
    {
      titleKey: "forOfflineVendor.howItWorks.steps.sell.title",
      descriptionKey: "forOfflineVendor.howItWorks.steps.sell.description",
              ...
              >
                ...
                <div className='absolute -top-4 -left-4 z-10'>
                  <div className='flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-r from-blue-500 to-purple-500 text-white shadow-lg'>
                    <Text className='text-lg font-bold'>{step.step}</Text>
                  </div>
                </div>
