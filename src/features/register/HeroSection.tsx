  ...
  return (
    <Section className='via-accent-900 relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-900 to-slate-900'>
        ...
        >
          ...
          >
            <div className='flex items-center gap-2 text-gray-300'>
              ...
              <span className='text-sm'>{t("register.hero.benefits.earlyAccess")}</span>
            </div>
            <div className='flex items-center gap-2 text-gray-300'>
              <div className='h-2 w-2 animate-pulse rounded-full bg-blue-400' />
              <span className='text-sm'>{t("register.hero.benefits.freeTrial")}</span>
            </div>
            <div className='flex items-center gap-2 text-gray-300'>
              <div className='h-2 w-2 animate-pulse rounded-full bg-purple-400' />
              <span className='text-sm'>{t("register.hero.benefits.prioritySupport")}</span>
            </div>
          </motion.div>
        </motion.div>
      </Container>
      ...
      >
        ...
        >
          <Text className='text-sm text-gray-400'>{t("register.hero.scrollIndicator")}</Text>
